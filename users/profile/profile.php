...
<div class="admin-wrapper">
    ...
    <div class="profile">
		...
		<form autocomplete="off" action="profilesub.php" method="post">
			...
			<div>
				...
				<input type="text" name="loc" class="text-input">
			</div>
			<div>
				<label>Joining Date</label>
				<input type="date" name="join_date" class="text-input">
			</div>
			<div>
				<label>Current Position</label>
				<input type="text" name="position" class="text-input">
			</div>
